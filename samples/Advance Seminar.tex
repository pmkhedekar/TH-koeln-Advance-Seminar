...
\title{Designing a Real-Time ESG Monitoring and Reporting Platform in Supply Chain Management: Integration of AI, IoT, and Blockchain-Powered Digital Twins}
...
\email{pranav_milind.khedekar@smail.th-koeln.de}
\orcid{0000-0003-3005-1362}

\affiliation{%
  \institution{Cologne University of Applied Sciences}
  \streetaddress{Gustav-Heinemann-Ufer 54}
  \city{Cologne}
...
\keywords{Supply Chain Management, Real-Time Monitoring, ESG Compliance, Reporting Platform, Artificial Intelligence (AI), Internet of Things (IoT), Blockchain, Digital Twins, Data Accuracy, Transparency, Industry 4.0, Sustainable Supply Chains,  Data Integrity, Virtual Representation, Environmental, Social, and Governance Factors, Sustainability Reporting, Integration of Technologies.}
